...
class CNN_LSTM_model(BaseModel):
    ...
    def build_model(self, embedding_matrix, seq_len, params):
        """This method is used to define and compile the keras model.
            ...
            Convolutional layer, there is MaxPooling layer which reduces the dimensionality of the problem. Next, 
            we have an LSTM layer which uses this lower-dimensional representation to classify the sequences. In 
            the end, there is a Dense layer which outputs the probability for the tweet being of the first class.
